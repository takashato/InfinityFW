<?php
/**
 * Project:     tplengine: the PHP compiling template engine
 * File:        tplengine.class.php
 *
 ...
 * tplengine mailing list. Send a blank e-mail to
...
/**
 * set SMARTY_DIR to absolute path to tplengine library files.
...
/**
 * set SMARTY_SYSPLUGINS_DIR to absolute path to tplengine internal plugins.
...
if (!defined('SMARTY_RESOURCE_CHAR_SET')) {
    ...
    /**
     * @deprecated in favor of tplengine::$_CHARSET
     */
    define('SMARTY_RESOURCE_CHAR_SET', SMARTY_MBSTRING ? 'UTF-8' : 'ISO-8859-1');
}
if (!defined('SMARTY_RESOURCE_DATE_FORMAT')) {
    /**
     * @deprecated in favor of tplengine::$_DATE_FORMAT
     */
...
/**
 * This is the main tplengine class
 *
 * @package tplengine
 *
...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * error handler returned by set_error_handler() in tplengine::muteExpectedErrors()
     */
    ...
    */
    ...
    /**
     * This object type (tplengine = 1, template = 2, data = 4)
     *
     * @var int
     */
    public $_objType = 1;
    ...
    /**
     * Initialize new tplengine object
     */
     ...
     *
     * @return Smarty                 current tplengine instance for chaining
     ...
     * @param  object  $parent     next higher level of tplengine variables
     * @param  boolean $do_clone   flag is tplengine object shall be cloned
     *
    ...
    public static function muteExpectedErrors()
    {
        /*
            ...
            tplengine deliberately uses @filemtime() over file_exists() and filemtime() in some places. Reasons include
