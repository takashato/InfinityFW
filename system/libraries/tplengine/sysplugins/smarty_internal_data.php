<?php
/**
 * tplengine Internal Plugin Data
...
class Smarty_Internal_Data
{
    ...
    /**
     * assigns a tplengine variable
     *
     * @param  array|string $tpl_var the template variable name(s)
     * @param  mixed        $value   the value to assign
     * @param  boolean      $nocache if true any output of this variable will be not cached
     *
     * @return Smarty_Internal_Data current Smarty_Internal_Data (or tplengine or Smarty_Internal_Template) instance for
     *                              chaining
     */
    ...
    /**
     * assigns a global tplengine variable
     *
    ...
    /**
     * gets the object of a tplengine variable
     *
     * @param  string               $variable      the name of the tplengine variable
    ...
    /**
     * Return true if this instance is a tplengine obj
     *
     * @return bool
     */
