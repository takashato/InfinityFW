<?php
/**
 * tplengine Internal Plugin Config File Compiler
...
class Smarty_Internal_Config_File_Compiler
{
    ...
    /**
     * Method to compile tplengine config source.
     *
    ...
    public function compileTemplate(Smarty_Internal_Template $template)
    {
        ...
        $template_header =
            "<?php /* tplengine version " . Smarty::SMARTY_VERSION . ", created on " . strftime("%Y-%m-%d %H:%M:%S") .
            "\n";
