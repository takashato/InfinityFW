<?php
/**
 * tplengine Internal Plugin Debug
 * Class to collect data for the tplengine Debugging Console
 *
 * @package    tplengine
 * @subpackage Debug
 * @author     Uwe Tews
...
/**
 * tplengine Internal Plugin Debug Class
 *
 * @package    tplengine
 * @subpackage Debug
 */
class Smarty_Internal_Debug extends Smarty_Internal_Data
{
    ...
    /**
     * Opens a window for the tplengine Debugging Console and display the data
     *
    ...
    public function display_debug($obj, $full = false)
    {
        ...
        // to avoid problems if the application did overload the tplengine class
        $debObj = new Smarty();
        // copy the working dirs from application
        $debObj->setCompileDir($smarty->getCompileDir());
        // init properties by hand as user may have edited the original tplengine class
    ...
    public function get_debug_vars($obj)
    {
        ...
        foreach ($obj->config_vars as $key => $var) {
            ...
            if ($obj->_isTplObj()) {
                ...
                $config_vars[ $key ][ 'scope' ] = 'tplengine object';
            }
        }
        $tpl_vars = array();
        foreach ($obj->tpl_vars as $key => $var) {
            ...
            if ($obj->_isTplObj()) {
                ...
                $tpl_vars[ $key ][ 'scope' ] = 'tplengine object';
            }
        }
