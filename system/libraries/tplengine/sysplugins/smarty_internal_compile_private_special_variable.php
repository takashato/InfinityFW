<?php
/**
 * tplengine Internal Plugin Compile Special tplengine Variable
...
/**
 * tplengine Internal Plugin Compile special tplengine Variable Class
 *
 * @package    tplengine
 * @subpackage Compiler
 */
class Smarty_Internal_Compile_Private_Special_Variable extends Smarty_Internal_CompileBase
{
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter)
    {
        ...
        if ($variable === false) {
            $compiler->trigger_template_error("special \$tplengine variable name index can not be variable", null, true);
        }
        if (!isset($compiler->smarty->security_policy) ||
            ...
            switch ($variable) {
                ...
                case 'version':
                    return "tplengine::SMARTY_VERSION";
