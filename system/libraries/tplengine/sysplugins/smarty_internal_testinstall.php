<?php
/**
 * tplengine Internal TestInstall
 * Test tplengine installation
 *
 * @package    tplengine
...
class Smarty_Internal_TestInstall
{
    ...
    public static function testInstall(Smarty $smarty, &$errors = null)
    {
        ...
        if ($errors === null) {
            echo "<PRE>\n";
            echo "tplengine Installation test...\n";
        ...
        if (!$_core_plugins_available) {
            $status = false;
            $message = "WARNING: tplengine's own libs/plugins is not available";
            if ($errors === null) {
                echo $message . ".\n";
