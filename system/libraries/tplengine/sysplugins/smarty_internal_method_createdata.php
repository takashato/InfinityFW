...
/**
 * tplengine Method CreateData
 *
 * tplengine::createData() method
 *
 * @package    tplengine
...
class Smarty_Internal_Method_CreateData
{
     ...
     *
     * @api  tplengine::createData()
     * @link http://www.smarty.net/docs/en/api.create.data.tpl
     *
     * @param \Smarty_Internal_TemplateBase|\Smarty_Internal_Template|\Smarty      $obj
     * @param \Smarty_Internal_Template|\Smarty_Internal_Data|\Smarty_Data|\Smarty $parent next higher level of tplengine
     *                                                                                     variables
