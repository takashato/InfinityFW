 ...
 *      - current implementation of isTrustedResourceDir() assumes that tplengine::$template_dir and tplengine::$config_dir are immutable
 *        the cache is killed every time either of the variables change. That means that two distinct tplengine objects with differing
...
{
    /**
     * This determines how tplengine handles "<?php ... ?>" tags in templates.
     * possible values:
     * <ul>
     *   <li>tplengine::PHP_PASSTHRU -> echo PHP tags as they are</li>
     *   <li>tplengine::PHP_QUOTE    -> escape tags as entities</li>
     *   <li>tplengine::PHP_REMOVE   -> remove php tags</li>
     *   <li>tplengine::PHP_ALLOW    -> execute php tags</li>
     * </ul>
     *
     * @var integer
     */
