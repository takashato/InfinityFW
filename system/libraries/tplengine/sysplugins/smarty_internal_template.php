...
/**
 * tplengine Internal Plugin Template
 * This file contains the tplengine template engine
 *
 * @package    tplengine
 * @subpackage Template
 * @author     Uwe Tews
...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * Template object cache for tplengine::isCached() == true
     *
     * @var Smarty_Internal_Template[]
     */
     ...
     * Some of the global tplengine settings copied to template scope
     * It load the required template resources and caching plugins
     *
     * @param string                                                       $template_resource template resource string
     * @param Smarty                                                       $smarty            tplengine instance
    ...
    /**
     * set tplengine property in template context
     *
    ...
    /**
     * get tplengine property in template context
     *
     * @param string $property_name property name
     *
