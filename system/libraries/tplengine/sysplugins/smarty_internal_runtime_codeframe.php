<?php
/**
 * tplengine Internal Extension
 * This file contains the tplengine template extension to create a code frame
 *
 * @package    tplengine
 * @subpackage Template
 * @author     Uwe Tews
...
class Smarty_Internal_Runtime_CodeFrame
{
                           ...
                           Smarty_Internal_TemplateCompilerBase $compiler = null)
    {
        ...
        $output = "<?php\n";
        $output .= "/* tplengine version " . Smarty::SMARTY_VERSION . ", created on " . strftime("%Y-%m-%d %H:%M:%S") .
